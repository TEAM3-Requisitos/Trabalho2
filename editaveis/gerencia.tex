...
As tarefas listadas foram cumpridas com o auxílio das técnicas de elicitação, Brainstorm e Entrevista.
...
Para a especificação dos épicos utilizou-se o padrão recomendado pelo SAFe, que é o template  \textit{lightweight business case}.
...
\section {\textit{Backlog Programa}}
