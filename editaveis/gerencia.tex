...
\begin{tabular}{|l|}
\hline
User Story 18 \\ \hline                                                                                                                                               \begin{tabular}[c]{@{}l@{}}Eu como usuário, quero dar like em projetos que acho pertinentes \\ para que o projeto tenha uma visibilidade maior no ranking.\end{tabular} \\ \hline
...
\begin{tabular}{|l|}
\hline
User Story 19  \\ \hline                                                                                                               \begin{tabular}[c]{@{}l@{}}Eu como usuário, quero visualizar projetos para obter informações\\ e detalhes do mesmo.\end{tabular} \\ \hline
...
\begin{tabular}{|l|}
\hline
User Story 20  \\ \hline                                                                                                                               \begin{tabular}[c]{@{}l@{}}Eu como criador do projeto, quero solicitar ajuda de outros \\ usuários para esclarecer minhas dúvidas.\end{tabular} \\ \hline
...
\begin{tabular}{|l|}
\hline
User Story 22 \\ \hline                                                                                                                                       \begin{tabular}[c]{@{}l@{}}Eu como criador do projeto, quero vender o projeto para lucrar \\ com as ideias e o valor comercial do projeto.\end{tabular} \\ \hline
...
\begin{tabular}{|l|}
\hline
User Story 23  \\ \hline                                                                                                                                                                  \begin{tabular}[c]{@{}l@{}}Eu como criador do projeto, quero transformar o projeto desenvolvido \\ em um produto consolidado para comercializar a ideia desenvolvida.\end{tabular} \\ \hline
...
\begin{tabular}{|l|}
\hline
User Story 24  \\ \hline                                                                                                                                                                                               \begin{tabular}[c]{@{}l@{}}Eu como criador do projeto, quero especificar preço, tipo, descrição, \\ tempo de entrega e forma de pagamento para facilitar a troca a comercialização \\ do produto.\end{tabular} \\ \hline
